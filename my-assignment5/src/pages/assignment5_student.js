...
import styles from '/Users/cathyluo/my-next-app/my-assignment5/src/styles/assignment5_styles.module.css'
...
function AirlineRoutes(){
    ...
    return <Container >
        ...
        <Row className={"justify-content-md-left"}>
        <Col lg={4}>
            <h2 className={styles.svgStyle}>Airlines</h2>
        ...
        <Col lg={4} >
            <h2 className={styles.svgStyle}>Airports</h2>
